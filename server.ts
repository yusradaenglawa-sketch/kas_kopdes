...
// Di Vercel, jangan panggil app.listen() — Vercel menjalankan app lewat api/index.ts
// sebagai serverless function. app.listen() hanya dipakai untuk dev lokal atau
// platform server tradisional seperti Railway/Render.
